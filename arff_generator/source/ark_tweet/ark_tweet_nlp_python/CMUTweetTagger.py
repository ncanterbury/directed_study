...
def _split_results(rows):
    """Parse the tab-delimited returned lines, modified from: https://github.com/brendano/ark_tweet-nlp/blob/master/scripts/show.py"""
    for line in rows:
...
def _call_runtagger(tweets, run_tagger_cmd=RUN_TAGGER_CMD):
    ...
    print("CMU Tagger Wrapper: Returned from calling Java POS Tagger")
